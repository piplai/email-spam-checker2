!(function (d) {
  ...
  (r.prototype = {
    init: function (e, i) {
      (this.$el = e),
        "function" === this.getType(i) && (i = { highlight: i }),
        "custom" === this.getType(i)
          ? ((this.highlight = i), this.generate())
    ...
    getType: function (e) {
      ...
      } else if ("function" == i || "string" == i) return i;
      return "other";
    },
    generate: function () {
      switch (
        (this.$el
          ...
          .on("input." + o, this.handleInput.bind(this))
          .on("scroll." + o, this.handleScroll.bind(this)),
        (this.$highlights = d("<div>", {
          class: "hwt-highlights hwt-content",
        })),
        (this.$backdrop = d("<div>", { class: o + "-backdrop" }).append(
          this.$highlights
        )),
        (this.$container = d("<div>", { class: o + "-container" })
          .insertAfter(this.$el)
    ...
    detectBrowser: function () {
      ...
      return -1 !== e.indexOf("firefox")
        ? "firefox"
        : e.match(/msie|trident\/7|edge/)
        ? "ie"
        : e.match(/ipad|iphone|ipod/) && -1 === e.indexOf("windows phone")
        ? "ios"
        : "other";
    },
    fixFirefox: function () {
      var e = this.$highlights.css([
          "padding-top",
          "padding-right",
          "padding-bottom",
          "padding-left",
        ]),
        i = this.$highlights.css([
          "border-top-width",
          "border-right-width",
          "border-bottom-width",
          "border-left-width",
      ...
      this.$highlights.css({ padding: "0", "border-width": "0" }),
        this.$backdrop
          ...
          .css({
            "margin-top": "+=" + i["border-top-width"],
            "margin-right": "+=" + i["border-right-width"],
            "margin-bottom": "+=" + i["border-bottom-width"],
            "margin-left": "+=" + i["border-left-width"],
          });
    },
    fixIOS: function () {
      this.$highlights.css({
    ...
    handleInput: function () {
      ...
      this.renderMarks(e), this.renderAside(e);
    },
    getRanges: function (e, i) {
      switch (this.getType(i)) {
        case "array":
          return this.getArrayRanges(e, i);
        case "function":
          return this.getFunctionRanges(e, i);
        case "regexp":
          return this.getRegExpRanges(e, i);
        case "string":
          return this.getStringRanges(e, i);
        case "range":
          return this.getRangeRanges(e, i);
        case "custom":
          return this.getCustomRanges(e, i);
        default:
          if (!i) return [];
          console.error("unrecognized highlight type");
      }
    },
    getArrayRanges: function (e, i) {
      i = i.map(this.getRanges.bind(this, e));
      return Array.prototype.concat.apply([], i);
    },
    getFunctionRanges: function (e, i) {
      return this.getRanges(e, i(e));
    },
    getRegExpRanges: function (e, i) {
      let g = [];
      for (
        var r;
        null !== (r = i.exec(e)) &&
        (g.push([r.index, r.index + r[0].length]), i.global);

      );
      return g;
    },
    getStringRanges: function (e, i) {
      let g = [],
        r = e.toLowerCase();
      var o = i.toLowerCase();
      let t = 0;
      for (; -1 !== (t = r.indexOf(o, t)); )
        g.push([t, t + o.length]), (t += o.length);
      return g;
    },
    getRangeRanges: function (e, i) {
      return [i];
    },
    getCustomRanges: function (e, i) {
      let g = this.getRanges(e, i.highlight);
      return (
        i.category &&
    ...
    removeStaggeredRanges: function (e) {
      ...
      return (
        e.forEach(function (i) {
          g.some(function (e) {
            return (i[0] > e[0] && i[0] < e[1]) != (i[1] > e[0] && i[1] < e[1]);
          }) || g.push(i);
        }),
        g
      );
      ...
      return (
        e.forEach(function (e) {
          i.push({
            ...
            i.push({ type: "stop", index: e[1] });
        }),
        this.sortBoundaries(i),
        i
      );
    },
    sortBoundaries: function (e) {
      e.sort(function (e, i) {
        return e.index !== i.index
          ? i.index - e.index
          : "stop" === e.type && "start" === i.type
          ? 1
          : "start" === e.type && "stop" === i.type
          ? -1
          : 0;
      });
    },
    renderMarks: function (g) {
      let r = this.$el.val();
      g.forEach(function (e, i) {
        ...
        (g =
          "start" === e.type
            ? "{{hwt-mark-start|" + i + "}}"
            : "{{hwt-mark-stop}}"),
          (r = r.slice(0, e.index) + g + r.slice(e.index));
      }),
        (r = (r = r.replace(/\n(\{\{hwt-mark-stop\}\})?$/, "\n\n$1"))
          .replace(/</g, "&lt;")
          .replace(/>/g, "&gt;")),
        (r = (r = (r =
          "ie" === this.browser ? r.replace(/ /g, " <wbr>") : r).replace(
          /\{\{hwt-mark-start\|(\d+)\}\}/g,
          function (e, i) {
            i = g[+i].category;
            return i ? '<mark class="spam-category-' + i + '">' : "<mark>";
          }
        )).replace(/\{\{hwt-mark-stop\}\}/g, "</mark>")),
        this.$highlights.html(r);
    },
    renderAside: function (r) {
      const e = this.$el.val();
      var o = e.split(/\s+/).length - 1,
        t = Math.round(o / 200);
      if (o < 2)
        d("#spam-checker--aside").html(
          "<i>Add content to get your spam score.</i>"
        );
      else {
        a =
          (a = "") +
          ("<tr><td>Words:</td><td>" + o + "</td></tr>") +
          ("<tr><td>Read time:</td><td>" +
            (t ? t + " min" : "a few seconds") +
            "</td></tr>");
        const y = {};
        let g = 0,
          i =
            (r.forEach((e) => {
              ...
              e.category &&
                ((i = e.category),
                (y[i] = y[i] || { type: i, keywords: [] }),
                y[i].keywords.push({ keyword: e.keyword }),
                g++);
            }),
            "");
        for (const n in y) {
        ...
        let e = g;
        (y.money || y.shady) && (e += 20),
          (y.urgency || y.overpromise) && (e += 10);
        var a =
          "<tr><td>Performance:</td><td>" +
          (20 < e
    ...
    (d.fn.highlightWithinTextarea = function (g) {
      return this.each(function () {
        ...
        else i && i.destroy(), (i = new r(e, g)).isGenerated && e.data(o, i);
      });
    }),
    d(function () {
      d("#spam-checker--textarea").highlightWithinTextarea({
        highlight: [
          { highlight: /\baccess\b/gi, keyword: "Access", category: "urgency" },
          {
            highlight: /\baccess now\b/gi,
            keyword: "Access now",
            category: "urgency",
          },
          ...
          {
            highlight: /\bapply here\b/gi,
            keyword: "Apply here",
            category: "urgency",
          },
          {
            highlight: /\bapply now\b/gi,
            keyword: "Apply now",
            category: "urgency",
          },
          {
          ...
          {
            highlight: /\bbuy direct\b/gi,
            keyword: "Buy direct",
            category: "urgency",
          },
          {
            highlight: /\bbuy now\b/gi,
            keyword: "Buy now",
            category: "urgency",
          },
          {
            highlight: /\bbuy today\b/gi,
            keyword: "Buy today",
            category: "urgency",
          },
          { highlight: /\bcall\b/gi, keyword: "Call", category: "urgency" },
          {
            highlight: /\bcall free\b/gi,
            keyword: "Call free",
            category: "urgency",
          },
          {
          ...
          {
            highlight: /\bcall me\b/gi,
            keyword: "Call me",
            category: "urgency",
          },
          {
            highlight: /\bcall now\b/gi,
            keyword: "Call now",
            category: "urgency",
          },
          {
          ...
          {
            highlight: /\bfor only\b/gi,
            keyword: "For Only",
            category: "urgency",
          },
          {
            highlight: /\bfor you\b/gi,
            keyword: "For you",
            category: "urgency",
          },
          {
          ...
          {
            highlight: /\bget it now\b/gi,
            keyword: "Get it now",
            category: "urgency",
          },
          {
            highlight: /\bget now\b/gi,
            keyword: "Get now",
            category: "urgency",
          },
          {
            highlight: /\bget paid\b/gi,
            keyword: "Get paid",
            category: "urgency",
          },
          {
          ...
          { highlight: /\ball-new\b/gi, keyword: "All-new", category: "shady" },
          {
            highlight: /\ballowance\b/gi,
            keyword: "Allowance",
            category: "shady",
          },
          {
            highlight: /\bas seen on\b/gi,
            keyword: "As seen on",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bbeneficiary\b/gi,
            keyword: "Beneficiary",
            category: "shady",
          },
          {
            highlight: /\bbill 1618\b/gi,
            keyword: "Bill 1618",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bdiagnostic\b/gi,
            keyword: "Diagnostic",
            category: "shady",
          },
          {
            highlight: /\bdiagnostics\b/gi,
            keyword: "DIAGNOSTICS",
            category: "shady",
          },
          ...
          {
            highlight: /\bfree iphone\b/gi,
            keyword: "Free iPhone",
            category: "shady",
          },
          {
            highlight: /\bfree laptop\b/gi,
            keyword: "Free laptop",
            category: "shady",
          },
          {
            highlight: /\bfree leads\b/gi,
            keyword: "Free leads",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bhidden fees\b/gi,
            keyword: "Hidden fees",
            category: "shady",
          },
          {
            highlight: /\bhigh score\b/gi,
            keyword: "High score",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bmass email\b/gi,
            keyword: "Mass email",
            category: "shady",
          },
          { highlight: /\bmedical\b/gi, keyword: "Medical", category: "shady" },
          {
            highlight: /\bmedicine\b/gi,
            keyword: "Medicine",
            category: "shady",
          },
          {
            highlight: /\bmeet girls\b/gi,
            keyword: "Meet girls",
            category: "shady",
          },
          ...
          {
            highlight: /\bmillionaire\b/gi,
            keyword: "Millionaire",
            category: "shady",
          },
          {
            highlight: /\bmillions\b/gi,
            keyword: "Millions",
            category: "shady",
          },
          ...
          {
            highlight: /\bno gimmick\b/gi,
            keyword: "No gimmick",
            category: "shady",
          },
          {
            highlight: /\bno hidden\b/gi,
            keyword: "No hidden",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bnot junk\b/gi,
            keyword: "Not junk",
            category: "shady",
          },
          {
            highlight: /\bnot scam\b/gi,
            keyword: "Not scam",
            category: "shady",
          },
          {
            highlight: /\bnot spam\b/gi,
            keyword: "Not spam",
            category: "shady",
          },
          { highlight: /\bnotspam\b/gi, keyword: "Notspam", category: "shady" },
          {
            highlight: /\bnumber 1\b/gi,
            keyword: "Number 1",
            category: "shady",
          },
          {
            highlight: /\bobligation\b/gi,
            keyword: "Obligation",
            category: "shady",
          },
          ...
          {
            highlight: /\bonline job\b/gi,
            keyword: "Online job",
            category: "shady",
          },
          { highlight: /\bopen\b/gi, keyword: "Open", category: "shady" },
          {
            highlight: /\bopportunity\b/gi,
            keyword: "Opportunity",
            category: "shady",
          },
          ...
          {
            highlight: /\bpassword\b/gi,
            keyword: "Password",
            category: "shady",
          },
          {
            highlight: /\bpasswords\b/gi,
            keyword: "Passwords",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bplease open\b/gi,
            keyword: "Please open",
            category: "shady",
          },
          {
            highlight: /\bpresently\b/gi,
            keyword: "Presently",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bpromise you\b/gi,
            keyword: "Promise you",
            category: "shady",
          },
          {
            highlight: /\bpurchase\b/gi,
            keyword: "Purchase",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\breal thing\b/gi,
            keyword: "Real thing",
            category: "shady",
          },
          { highlight: /\brebate\b/gi, keyword: "Rebate", category: "shady" },
          {
            highlight: /\breduce debt\b/gi,
            keyword: "Reduce debt",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bsave money\b/gi,
            keyword: "Save money",
            category: "shady",
          },
          {
            highlight: /\bsave now\b/gi,
            keyword: "Save now",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bsuper promo\b/gi,
            keyword: "Super promo",
            category: "shady",
          },
          {
            highlight: /\bsupplies\b/gi,
            keyword: "Supplies",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bunsolicited\b/gi,
            keyword: "Unsolicited",
            category: "shady",
          },
          {
            highlight: /\bunsubscribe\b/gi,
            keyword: "Unsubscribe",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\byour chance\b/gi,
            keyword: "Your chance",
            category: "shady",
          },
          {
            highlight: /\byour status\b/gi,
            keyword: "Your status",
            category: "shady",
          },
          {
            highlight: /\bzero chance\b/gi,
            keyword: "Zero chance",
            category: "shady",
          },
          {
          ...
          {
            highlight: /\bamazed\b/gi,
            keyword: "Amazed",
            category: "overpromise",
          },
          {
            highlight: /\bamazing\b/gi,
            keyword: "Amazing",
            category: "overpromise",
          },
          {
          ...
          {
            highlight: /\bprize\b/gi,
            keyword: "Prize",
            category: "overpromise",
          },
          {
            highlight: /\bpromise\b/gi,
            keyword: "Promise",
            category: "overpromise",
          },
          {
          ...
          {
            highlight: /\bbad credit\b/gi,
            keyword: "Bad credit",
            category: "money",
          },
          { highlight: /\bbank\b/gi, keyword: "Bank", category: "money" },
          {
            highlight: /\bbankruptcy\b/gi,
            keyword: "Bankruptcy",
            category: "money",
          },
          ...
          {
            highlight: /\bcash bonus\b/gi,
            keyword: "Cash bonus",
            category: "money",
          },
          {
            highlight: /\bcash out\b/gi,
            keyword: "Cash out",
            category: "money",
          },
          {
          ...
          {
            highlight: /\bearn [\$£€¥]+\b/gi,
            keyword: "Earn $",
            category: "money",
          },
          {
            highlight: /\bearn cash\b/gi,
            keyword: "Earn cash",
            category: "money",
          },
          {
          ...
          {
            highlight: /\beasy income\b/gi,
            keyword: "Easy income",
            category: "money",
          },
          {
            highlight: /\beasy terms\b/gi,
            keyword: "Easy terms",
            category: "money",
          },
          { highlight: /\bf r e e\b/gi, keyword: "F r e e", category: "money" },
          {
            highlight: /\bfor free\b/gi,
            keyword: "For free",
            category: "money",
          },
          {
          ...
          {
            highlight: /\binsurance\b/gi,
            keyword: "Insurance",
            category: "money",
          },
          {
            highlight: /\binvestment\b/gi,
            keyword: "Investment",
            category: "money",
          },
          {
          ...
          {
            highlight: /\brefinance\b/gi,
            keyword: "Refinance",
            category: "money",
          },
          {
            highlight: /\bsave [\$£€¥]+\b/gi,
            keyword: "Save $",
            category: "money",
          },
          {
          ...
          {
            highlight: /\baccounts\b/gi,
            keyword: "Accounts",
            category: "unnatural",
          },
          {
            highlight: /\baddresses\b/gi,
            keyword: "Addresses",
            category: "unnatural",
          },
          {
          ...
          {
            highlight: /\bfreedom\b/gi,
            keyword: "Freedom",
            category: "unnatural",
          },
          {
            highlight: /\bfriend\b/gi,
            keyword: "Friend",
            category: "unnatural",
          },
          { highlight: /\bhere\b/gi, keyword: "Here", category: "unnatural" },
          {
            highlight: /\bhidden\b/gi,
            keyword: "Hidden",
            category: "unnatural",
          },
          ...
          {
            highlight: /\bopt in\b/gi,
            keyword: "Opt in",
            category: "unnatural",
          },
          {
            highlight: /\bper day\b/gi,
            keyword: "Per day",
            category: "unnatural",
          },
          {
            highlight: /\bper week\b/gi,
            keyword: "Per week",
            category: "unnatural",
          },
          {
          ...
          {
            highlight: /\bproblem\b/gi,
            keyword: "Problem",
            category: "unnatural",
          },
          {
            highlight: /\bremoval\b/gi,
            keyword: "Removal",
            category: "unnatural",
          },
          {
            highlight: /\bremove\b/gi,
            keyword: "Remove",
            category: "unnatural",
          },
          {
          ...
          {
            highlight: /\breverses\b/gi,
            keyword: "Reverses",
            category: "unnatural",
          },
          {
            highlight: /\bsample\b/gi,
            keyword: "Sample",
            category: "unnatural",
          },
          {
